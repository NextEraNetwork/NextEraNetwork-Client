...
const UpdateProfile: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4 lg:p-16">
          ...
          {TABS.map(tab => (
            <button
              ...
              className={`flex-shrink-0 px-4 py-2 rounded-lg transition duration-300 whitespace-nowrap 
                ${activeTab === tab.id ? 'bg-blue-500 text-white shadow' : 'bg-gray-200 text-gray-700 hover:bg-gray-300'}`}
